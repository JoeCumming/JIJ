...
class VideoCreator(object):
    ...
    def __init__(self, appcontext, video:Video):
        self.compositor = CompositeVideoCreator(appcontext)        
    ...
    def createAndUpload(self):
        ...
        self.status('Creating composite video...')
        self.create()
        self.status('Composite video created')
    ...
    def create(self):
        ...
        self.status('Parsing ' + source_url)
        ...
        for div in qandasection:
            ...
            if not os.path.exists(video):
                with requests.get(answer_video, allow_redirects=True) as r:
                    ...
                    self.appcontext.status("Saving answer {}".format(i))
